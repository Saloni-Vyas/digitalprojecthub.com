 ...
 <div class="container max-w-7xl py-4 px-7 mx-auto">
   <div class="flex flex-row max-w-full justify-center mx-auto">
     ...
     <div class="content-center rounded border-2">
       <marquee class="align-center mt-2 mr-4" direction="scroll"><b><a href="/#contact">Sale your final year project Code / Document send request at <span class="text-red-600">rohitbhure.cse@gmail.com</span> or WhatsApp: <span class="text-red-600">+91-8839178090 😊</span></a></b></marquee>
     </div>
   </div>
 </div>