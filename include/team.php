    ...
    <div class="flex justify-center flex-wrap -m-2">
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center p-4 rounded-lg bg-white">
          <img alt="team" class="w-20 h-20 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="<?php echo $website;?>/images/team/rohit.jpg" decoding="async"
                  loading="lazy">
          <div class="flex-grow">
      ...
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center p-4 rounded-lg bg-white">
          <img alt="team" class="w-20 h-20 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="<?php echo $website;?>/images/team/divyansh.jpg" decoding="async"
                  loading="lazy">
          <div class="flex-grow">
            <h2 class="text-gray-900 title-font font-medium mb-1">Divyansh Sharma</h2>
            <p class="text-gray-500">I am Divyansh Sharma, a passionate and dedicated computer science student currently in my third year of B.Tech.</p>
          </div>
        </div>
      </div>
