  ...
  <div class="relative w-full bg-white">
    <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
      ...
      <div class="inline-flex items-center space-x-2">
        ...
        <a href="/" class="inline-flex items-center text-sm font-semibold text-gray-800 hover:text-gray-900">
      ...
      <div class="hidden grow items-start justify-end lg:flex">
        <ul class="ml-12 inline-flex space-x-8">
          ...
          <li>
            <a href="/#team" class="inline-flex items-center text-sm font-semibold text-gray-800 hover:text-gray-900">
              Team
              <!-- <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            <a href="#project" class="inline-flex items-center mr-4 text-sm font-semibold text-gray-800 hover:text-gray-900">
              Projects
              <!-- <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      >
      <a href="/#contact" class="block relative rounded overflow-hidden">Join Us</a>
      </button> -->
      <button
        type="button"
      ...
      >
      <a href="/#join" class="block relative rounded overflow-hidden">Join Us</a>
      </button>
    </div>
      <div class="lg:hidden">
