    ...
    <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
      ...
      <div class="inline-flex items-center space-x-2">
        ...
        <a href="/digitalprojecthub.com/" class="inline-flex items-center text-sm font-semibold text-gray-800 hover:text-gray-900">
          <span class="text-lg">DigitalProjectHub</span>
      </div>
      </a>
      <div class="hidden grow items-start justify-end lg:flex">
        <ul class="ml-12 inline-flex space-x-8">
          ...
          <li>
            <a href="/digitalprojecthub.com/projects.php?technology=&search=" class="inline-flex items-center text-sm font-semibold text-gray-800 hover:text-gray-900">
              Projects
              <!-- <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
