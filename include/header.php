  ...
  <div class="relative w-full bg-white">
    <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
      ...
      <div class="inline-flex items-center space-x-2">
        ...
        <a href="/digitalprojecthub.com/" class="inline-flex items-center text-sm font-semibold text-gray-800 hover:text-gray-900">
          <h1 class="text-xl">DigitalProjectHub</h1>
      </div>
      </a>
      <div class="hidden grow items-start justify-end lg:flex">
        <ul class="ml-12 inline-flex space-x-8">
          ...
          <li>
            <a href="/digitalprojecthub.com/#team" class="inline-flex items-center text-sm font-semibold text-gray-800 hover:text-gray-900">
              Team
              <!-- <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            <a href="/digitalprojecthub.com/#contact" class="inline-flex items-center text-sm font-semibold text-gray-800 hover:text-gray-900">
              Contact
              <!-- <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            <a href="/digitalprojecthub.com/projects.php?technology=&search=" class="inline-flex items-center mr-4 text-sm font-semibold text-gray-800 hover:text-gray-900">
              Projects
              <!-- <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="hidden space-x-2 ml-2 lg:block">
      <!-- <button
        type="button"
      ...
      >
      <a href="http://localhost/digitalprojecthub.com/#contact" class="block relative rounded overflow-hidden">Join Us</a>
      </button> -->
      <button
        type="button"
      ...
      >
      <a href="http://localhost/digitalprojecthub.com/#join" class="block relative rounded overflow-hidden">Join Us</a>
      </button>
    </div>
      <div class="lg:hidden">
